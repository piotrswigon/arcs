...
`function(
    ...
    it(`accepts existing indent at a place of invocation`, () => {
      const numberOfIndents = 3;
      const startString = '\n' + ' '.repeat(ktUtils.pref.indent * (numberOfIndents - 1));
      assert.equal(
        startString + ktUtils.applyFun('function', [
          'argument1_argument1_argument1_argument1_argument1_argument1_argument1',
          'argument2_argument2_argument2_argument2_argument2_argument2_argument2',
          'argument3_argument3_argument3_argument3_argument3_argument3_argument3'
        ], {numberOfIndents}), `
        function(
            argument1_argument1_argument1_argument1_argument1_argument1_argument1,
            argument2_argument2_argument2_argument2_argument2_argument2_argument2,
