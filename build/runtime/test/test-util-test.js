...
describe('util', () => {
    ...
    it('setDiffCustom works with JSON.stringify as the key function', () => {
        ...
        check(keyFn, [true, { a: 1 }, 7, { a: 1 }, { b: 2 }], [9, { b: 2 }, 7, { c: 3 }, 'x', { c: 3 }], { add: [9, 'x', { c: 3 }], remove: [true, { a: 1 }] });
        check(keyFn, [{ a: 1 }, { a: 2 }, { b: 3 }], [{ a: 1 }, { b: 4 }], { add: [{ b: 4 }], remove: [{ a: 2 }, { b: 3 }] });
    });
    it('setDiffCustom works with an object-specific key function', () => {
        ...
        check(keyFn, [{ a: 9, b: 8 }, { a: 7 }, { b: 6 }, { a: 9, b: 8 }, { b: 6 }], [{ a: 9, b: 8 }, { a: 1 }, { a: 4, b: 6 }], { add: [{ a: 1 }, { a: 4, b: 6 }], remove: [{ a: 7 }, { b: 6 }] });
        // Extra fields are ignored.
        check(keyFn, [{ a: 1, b: 2, c: 3 }], [{ a: 1, b: 2, c: 4 }], { add: [], remove: [] });
    });
});
//# sourceMappingURL=test-util-test.js.map