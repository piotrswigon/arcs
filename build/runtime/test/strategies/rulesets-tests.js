...
class AssignFateA extends FateAssigner {
    constructor() { super('copy'); }
}
class AssignFateB extends FateAssigner {
    constructor() { super('map'); }
}
class AssignFateC extends FateAssigner {
...
//# sourceMappingURL=rulesets-tests.js.map