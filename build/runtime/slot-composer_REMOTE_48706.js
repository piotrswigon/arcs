...
export class SlotComposer {
    ...
    createHostedSlot(transformationParticle, transformationSlotName, hostedParticleName, hostedSlotName, storeId, innerArc) {
        ...
        recipeParticles.forEach(p => {
            Object.values(p.consumedSlotConnections).forEach(cs => {
                ...
                if (slotConsumer && slotConsumer instanceof HostedSlotConsumer) {
                    ...
                    slotConsumer = new this._modality.slotConsumerClass(arc, cs, this._containerKind);
...
//# sourceMappingURL=slot-composer_REMOTE_48706.js.map