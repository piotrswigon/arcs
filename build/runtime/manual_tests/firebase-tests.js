...
describe('firebase', function () {
    ...
    describe('big collection', () => {
      ...
      `);
            ...
            await checkStream(col, items, 50, true, ['i02', 'q04', 'h05', 'g08', 'o10', 'w12', 'e13', 'j14', 't15', 's16', 'm17']);
      ...
      `);
            ...
            await checkDone(col, cid1);
            // Streaming again should be up-to-date (even with cursor2 still in flight).
            await checkStream(col, items, 50, false, ['m17', 's16', 't15', 'e13', 'f11', 'o10', 'p07', 'h05', 'z03', 'i02', 'r01']);
            // [*] ---> so that this page is only removed items.
        ...
        `
            ...
            const bigStore = await storage.construct('test0', dataType.bigCollectionOf(), newStoreKey('bigcollection'));
        ...
        `
            ...
            const storage = createStorage(arc.id);
            const dataType = new EntityType(manifest.schemas.Data);
            const varStore = await storage.construct('test0', dataType, newStoreKey('variable'));
            const colStore = await storage.construct('test1', dataType.collectionOf(), newStoreKey('collection'));
            const bigStore = await storage.construct('test2', dataType.bigCollectionOf(), newStoreKey('bigcollection'));
...
//# sourceMappingURL=firebase-tests.js.map