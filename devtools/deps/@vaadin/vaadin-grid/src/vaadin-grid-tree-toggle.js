/// BareSpecifier=@vaadin/vaadin-grid/src/vaadin-grid-tree-toggle
/**
@license
...
`;
  ...
  _levelChanged(level) {
    ...
    this._debouncerUpdateLevel = Debouncer.debounce(this._debouncerUpdateLevel, microTask, () => this.updateStyles({ '---level': value }));
  }
}
