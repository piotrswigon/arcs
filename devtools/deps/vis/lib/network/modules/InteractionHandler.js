/// BareSpecifier=vis/lib/network/modules/InteractionHandler
...
class InteractionHandler {
  ...
  onTap(event) {
    ...
    let multiselect = this.selectionHandler.options.multiselect && (event.changedPointers[0].ctrlKey || event.changedPointers[0].metaKey);
